...
public class IHM extends JFrame {
	...
	ArrayList<Afficheur> liAfficheurs ; // Les afficheurs qui observent le capteur
	...
	public IHM() {
		...
		startBut = new JButton("START");  startBut.setBackground(Color.GREEN);
		stopBut = new JButton("STOP"); stopBut.setBackground(Color.ORANGE);
		...
		startBut.addActionListener( new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
			    ...
			    if(atomiquecmd==null && seqcmd==null && epoquecmd==null){
			    	//JOptionPane.showInternalMessageDialog(getParentFrame(), "choose a strategy !", "", 0, null);	
			    }else{
	...
	private void registerObservers(CapteurImpl c){
		System.out.println("IHM: register "+liAfficheurs.size()+" observers" );
