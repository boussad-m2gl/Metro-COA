...
public class CanalImpl implements Canal {
	...
	public void update(EpoqMessage msg) {
		...
		UpdateAfficheurCallableEpoque callableEpoquSart = new UpdateAfficheurCallableEpoque(msg, (Afficheur)_afficheur);
		Future<Integer> f = MyExecutorService.submit(callableEpoquSart, innerDlay * 100); 
